    ...
    static define() {
        CodeMirror.defineSimpleMode('gnes-basic', {
            ...
            start: [
                ...
                {regex: /(?:Of|Type|End|Property|Return|New|Print|Break|Continue|From|To|Step|By|Load|Sprite|Move|Invoke|In|Shared|Wait|And|Or|Show|Hide|Run|Get|Required|Optional|Incompatible|Tilemap|Assert|Pre Update|Post Update)\b/, token: 'keyword'},
